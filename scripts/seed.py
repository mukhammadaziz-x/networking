...
def seed(db):
    ...
    if db.bind.dialect.name == "postgresql":
        db.execute(text("TRUNCATE TABLE order_items, orders, tasks, deals, contacts, companies, activities, users, products RESTART IDENTITY CASCADE;"))
        db.commit()
    else:
        ...
        if db.bind.dialect.name == "sqlite":
            for table in ["order_items", "orders", "tasks", "deals", "contacts", "companies", "activities", "users", "products"]:
